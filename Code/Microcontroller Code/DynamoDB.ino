...
const char* AWS_REGION = "us-east-2";  // REPLACE with your region
const char* AWS_ENDPOINT = "amazonaws.com";

// Init and connect Esp8266 WiFi to local wlan
const char* pSSID = "2GSpeed"; // REPLACE with your network SSID (name)
const char* pPassword = "kuchnahi"; // REPLACE with your network password (use for WPA, or use as key for WEP)

// Constants describing DynamoDB table and values being used
const char* TABLE_NAME = "ESPAWS";//"ESP8266AWSDemo";
