...
/* --> pwmLEDFxn */
extern xdc_Void pwmLEDFxn(xdc_UArg,xdc_UArg);
#ifdef __IAR_SYSTEMS_ICC__
    #pragma data_alignment=8
#endif
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/embedded/pwmled_EK_TM4C123GXL_TI_TivaTM4C123GH6PM/Debug/configPkg/package/cfg/pwmled_pem4f");
...
__FAR__ const CT__ti_sysbios_family_arm_lm4_Timer_Module__id ti_sysbios_family_arm_lm4_Timer_Module__id__C = (xdc_Bits16)0x25;
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[2] = {
    {/* instance#0 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg,xdc_UArg))((xdc_Fxn)pwmLEDFxn)),  /* fxn */
        ((xdc_UArg)(0x32)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)0),  /* env */
        ((void*)0),  /* hookEnv */
