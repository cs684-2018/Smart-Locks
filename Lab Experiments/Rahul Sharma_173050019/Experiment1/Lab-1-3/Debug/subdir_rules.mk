...
lab-1.obj: ../lab-1.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"/home/rahul/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.3.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="/root/TIVA_Workspace/Lab-1-3" --include_path="/home/rahul/ti/TivaWare_C_Series-2.1.2.111" --include_path="/home/rahul/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.3.LTS/include" --define=ccs="ccs" --define=PART_TM4C123GH6PM -g --gcc --diag_warning=225 --diag_wrap=off --display_error_number --abi=eabi --preproc_with_compile --preproc_dependency="lab-1.d" $(GEN_OPTS__FLAG) "$(shell echo $<)"
